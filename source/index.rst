...
**請注意：** 這是適用於舊版LimeSurvey 3的舊版學習手冊。最新版LimeSurvey 4，
請參閱 `新版LimeSurvey 4學習手冊`_ 。

本學習手冊以一個常用的教學研究範例，帶領學習者一步步操作，熟悉使用台師大問卷調查
平台LimeSurvey的常用功能。全部研讀完畢約需兩小時。您也可以直接跳到您有興趣的章
節，不需要依序閱讀。
...
註：舊版LimeSurvey 2，請參閱 `舊版LimeSurvey 2學習手冊`_ 。
...
.. _原始檔: https://limesurvey.imacat.idv.tw/learning/v3/learning-limesurvey-3.2.zip
